...
function replaceUrlLangTheme(nextLang: string, nextTheme: ThemeKey) {
...
export default function RecordsClient() {
  ...
  function displayCategory(value?: string | null) {
    return displayCategoryByLang(value, lang);
  }

  async function init(currentLang: typeof lang, currentTheme: ThemeKey) {
    const q = new URLSearchParams(window.location.search);
  ...
  function goRelatedFeature() {
    window.location.href = buildUrl(relatedPath);
  }
  ...
  const summaryProfit = summaryIncome - summaryExpense;
